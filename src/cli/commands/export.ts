...
export function registerExportCommand(program: Command): void {
  program
    ...
    .action(async (opts: { model?: string; modelId?: string; format: string; details: boolean; json?: boolean; force?: boolean }) => {
      ...
      try {
        ...
        let result: { filePath: string; objectCount: number; relationshipCount: number; drawingCount: number };
