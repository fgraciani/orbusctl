...
let exitData: { sessionStart: Date; tokensUsed: number; user?: string } | null = null;

function storeExitData(sessionStart: Date, tokensUsed: number, user?: string): void {
...
const cleanup = () => {
  ...
  if (exitData) printExitSummary(exitData.sessionStart, exitData.tokensUsed, exitData.user);
};
...
render(<App onStoreExitData={storeExitData} />);
