...
import { fetchDrawings, fetchDocumentTypes, type Drawing } from '../api/drawings.js';
...
function stripArchiMate(name: string): string {
...
export async function performMarkdownExport(
  ...
  const detailsById = new Map<string, ObjectDetail>();
